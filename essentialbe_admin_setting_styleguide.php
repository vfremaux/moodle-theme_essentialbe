 ...
 */
class essentialbe_admin_setting_styleguide extends admin_setting {
    ...
    public function __construct($name, $visiblename, $description) {
        ...
        if (($PAGE->bodyid == 'page-admin-setting-' . $name) ||
            ...
            $bc->title = get_string('styleguide', 'theme_essentialbe');
            ...
            $PAGE->requires->js_call_amd('theme_essentialbe/styleguide', 'init');
        }
