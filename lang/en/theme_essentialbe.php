...
<p>Essential Business Edition is based upon original Essential theme with special additions of Edunao.</p>
...
$string['fontcharactersetdesc'] = 'Pick additional character sets for different languages. Using many character sets can slow down your Moodle, so only select the character sets that you actually need.';
...
$string['marketingsecondrowenable'] = 'Enable second row';
...
$string['marketingsecondrow'] = 'Second marketing row';
$string['marketingsecondrowdesc'] = 'You may use a second row of marketing slots.';
...
$string['readme_desc'] = 'Please {$a->url} file, which contains more information about the Essential BE theme including customisation.';
$string['readme_title'] = 'Essential BE read-me';
...
$string['sponsor_title'] = 'Sponsor Essential BE';
...
$string['technical'] = 'Technical operations';
$string['adduser'] = 'Add a user';
$string['uploadusers'] = 'Import users';
...
$string['myprofile'] = 'See my profile';
$string['editmyprofile'] = 'Update my profile';
