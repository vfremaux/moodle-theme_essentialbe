...
$string['essentialbe:configure'] = 'Can configure the theme';
...
$string['marketingsecondrowenable'] = 'Enables second row of marketing spots';
...
$string['marketingsecondrowdesc'] = 'You can choose to add a second marketing row below the firstone, individually configurable.';
