...
$thispageurl = new moodle_url('/theme/essentialbe/pages/styleguide.php');
...
$title = get_string('styleguide', 'theme_essentialbe');
$setting = new essentialbe_admin_setting_styleguide('theme_essentialbe_styleguide',
