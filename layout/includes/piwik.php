...
{
    $siteurl = theme_essentialbe_get_setting('analyticssiteurl');
    $tracking = '';

    if (!empty($siteurl)) {
        $imagetrack = theme_essentialbe_get_setting('analyticsimagetrack');
        $siteid = theme_essentialbe_get_setting('analyticssiteid');
        $trackadmin = theme_essentialbe_get_setting('analyticstrackadmin');
        $cleanurl = theme_essentialbe_get_setting('analyticscleanurl');
        ...
        if ($cleanurl) {
            $doctitle = "_paq.push(['setDocumentTitle', " . theme_essentialbe_analytics_trackurl() . "]);";
        } else {
            $doctitle = "";
        }
