                ...
                echo (!$left) ? ' pull-right' : ' pull-left'; ?>">
                    <?php if (!$haslogo) { ?>
                        <a class="textlogo" href="<?php echo preg_replace("(https?:)", "", $CFG->wwwroot); ?>">
                            <i id="headerlogo" class="fa fa-<?php echo theme_essentialbe_get_setting('siteicon'); ?>"></i>
                            <?php echo theme_essentialbe_get_title('header'); ?>
                        </a>
                    <?php } else { ?>
            ...
            <div class="container-fluid navbar-inner">
                <div class="row-fluid">
                    <div class="custommenus pull-<?php echo ($left) ? 'left' : 'right'; ?>">
                        ...
                        <?php echo theme_essentialbe_get_title('navbar'); ?>
