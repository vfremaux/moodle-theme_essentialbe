...
if (empty($PAGE->layout_options['nofooter'])) {
    ...
    <footer role="contentinfo" id="page-footer">
        <div class="container-fluid">
            <?php echo theme_essentialbe_edit_button('theme_essentialbe_footer'); ?>
...
<?php } ?>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            <?php
            if (theme_essentialbe_not_lte_ie9()) {
              echo "jQuery('#essentialbenavbar').affix({";
              echo "offset: {";
            ...
            if (theme_essentialbe_get_setting('fitvids')) {
                echo "$('#page').fitVids();";
            }
            ?>
        });
