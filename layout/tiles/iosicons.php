...
if (\theme_essentialbe\toolbox::get_setting('iphoneicon')) {
    $iphoneicon = \theme_essentialbe\toolbox::get_setting('iphoneicon', 'format_file_url');
} else {
    $iphoneicon = $OUTPUT->pix_url('homeicon/iphone', 'theme');
}
if (\theme_essentialbe\toolbox::get_setting('ipadicon')) {
    $ipadicon = \theme_essentialbe\toolbox::get_setting('ipadicon', 'format_file_url');
} else {
    $ipadicon = $OUTPUT->pix_url('homeicon/ipad', 'theme');
}
if (\theme_essentialbe\toolbox::get_setting('iphoneretinaicon')) {
    $iphoneretinaicon = \theme_essentialbe\toolbox::get_setting('iphoneretinaicon', 'format_file_url');
} else {
    $iphoneretinaicon = $OUTPUT->pix_url('homeicon/iphone_retina', 'theme');
}
if (\theme_essentialbe\toolbox::get_setting('ipadretinaicon')) {
    $ipadretinaicon = \theme_essentialbe\toolbox::get_setting('ipadretinaicon', 'format_file_url');
} else {
