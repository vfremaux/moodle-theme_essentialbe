...
function theme_essentialbe_analytics_trackurl() {
    global $DB, $PAGE;
...
function theme_essentialbe_insert_analytics_tracking() {
    $siteurl = \theme_essentialbe\toolbox::get_setting('analyticssiteurl');
    $tracking = '';

    if (!empty($siteurl)) {
        $imagetrack = \theme_essentialbe\toolbox::get_setting('analyticsimagetrack');
        $siteid = \theme_essentialbe\toolbox::get_setting('analyticssiteid');
        $trackadmin = \theme_essentialbe\toolbox::get_setting('analyticstrackadmin');
        $useuserid = \theme_essentialbe\toolbox::get_setting('analyticsuseuserid');
        $cleanurl = \theme_essentialbe\toolbox::get_setting('analyticscleanurl');
        ...
        if ($cleanurl) {
            $doctitle = "".PHP_EOL."_paq.push(['setDocumentTitle', " . theme_essentialbe_analytics_trackurl() . "]);";
        } else {
            $doctitle = "";
        }
...
echo theme_essentialbe_insert_analytics_tracking();