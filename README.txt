...
http://moodle.org/plugins/view.php?plugin=theme_essentialbe
and
https://github.com/gjb2048/moodle-theme_essentialbe/releases
...
https://github.com/gjb2048/moodle-theme_essentialbe and doing a 'Pull Request' so that the rest of the
...
Installation
============
 1. Ensure you have the version of Moodle as stated above in 'Required version of Moodle'.  This is essentialbe as the
    theme relies on underlying core code that is out of our control.
 2. Login as an administrator and put Moodle in 'Maintenance Mode' so that there are no users using it bar you as the administrator.
 3. Copy the extracted 'essentialbe' folder to the '/theme/' folder.
...
=========
 1. Ensure you have the version of Moodle as stated above in 'Required version of Moodle'.  This is essentialbe as the
    theme relies on underlying core code that is out of our control.
 2. Login as an administrator and put Moodle in 'Maintenance Mode' so that there are no users using it bar you as the administrator.
 3. Make a backup of your old 'essentialbe' folder in '/theme/' and then delete the folder.
 4. Copy the replacement extracted 'essentialbe' folder to the '/theme/' folder.
...
==============
 ...
 3. In '/theme/' remove the folder 'essentialbe'.
...
4.  In '/theme/' remove the folder 'essentialbe' i.e. ALL of the contents - this is VITAL.
5.  Put in the replacement 'essentialbe' folder into '/theme/'.
6.  In the database, remove the row with the 'plugin' of 'theme_essentialbe' and 'name' of 'version' in the 'config_plugins' table, then
...
Reporting issues
================
Before reporting an issue, please ensure that you are running the latest version for your release of Moodle.  It is essentialbe
...
or check the issue list https://github.com/gjb2048/moodle-theme_essentialbe/issues and if the problem does not exist, create an
issue.

It is essentialbe that you provide as much information as possible, the critical information being the contents of the theme's 
...
- FIX: Issue #356: Incorrect $filename in /pluginfile.php/1/theme_essentialbe/style/<timestamp>/essentialbe.css.
...
- FIX: Issue #321: Theme not load essentialbe.css when using https on login page.
...
- FIX: Moved all RTL to separate sheet from main CSS.  Sheet 'essentialbe-rtl' uses 'flipped' technology ('grunt-css-flip') whilst 'rtl' sheet has manual styles.
...
- Now has a companion Mahara ePorfolio theme so you can keep them looking alike - https://github.com/moodleman/mahara-theme_essentialbe
...
If you have questions you can post them in the issue tracker at https://github.com/gjb2048/moodle-theme_essentialbe/issues