...
trait core_renderer_toolbox {
    ...
    public function get_tile_file($filename) {
        ...
        if (file_exists("$CFG->dirroot/theme/essentialbe/layout/tiles/$filename")) {
            return "$CFG->dirroot/theme/essentialbe/layout/tiles/$filename";
        } else if (!empty($CFG->themedir) and file_exists("$CFG->themedir/essentialbe/layout/tiles/$filename")) {
            return "$CFG->themedir/essentialbe/layout/tiles/$filename";
        } else {
