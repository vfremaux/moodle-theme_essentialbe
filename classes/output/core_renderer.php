...
class core_renderer extends \core_renderer {
    ...
    protected $essentialbe = null; // Used for determining if this is a Essential or child of renderer.
    ...
    public function navbar() {
        ...
        if ($breadcrumbstyle) {
            ...
            if (($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse')) {
                $showcategories = \theme_essentialbe\toolbox::get_setting('categoryincoursebreadcrumbfeature');
            }
    ...
    public function footer() {
        ...
        if (defined('MDL_PERF') || (!empty($CFG->perfdebug) and $CFG->perfdebug > 7)) {
            ...
            if (defined('MDL_PERFTOFOOT') || debugging() || $CFG->perfdebug > 7) {
                $performanceinfo = $this->performance_output($perf, \theme_essentialbe\toolbox::get_setting('perfinfo'));
            }
        }
    ...
    public function heading($text, $level = 2, $classes = null, $id = null) {
        ...
        if (($level == 2) && ($this->page->pagelayout == 'incourse') && (is_object($this->page->cm)) &&
            (\theme_essentialbe\toolbox::get_setting('returntosectionfeature'))) {
            static $called = false;
            if (!$called) {
    ...
    public function course_content_header($onlyifnotcalledbefore = false) {
        ...
        if ($this->page->pagelayout == 'mydashboard') {
            if (\theme_essentialbe\toolbox::course_content_search()) {
                ...
                $content .= '<div><p>'.get_string('findcoursecontent', 'theme_essentialbe').'</p></div>';
        ...
        if ($currentcatid) {
            ...
            if ($image) {
                ...
                if ($imageurl) {
                    ...
                    $parents = \theme_essentialbe\toolbox::get_categories_list()[$currentcatid]->parents;
    ...
    protected function return_to_section() {
        ...
        if ($markup === null) {
            ...
            if ($sectionnamelen !== false) {
                $sectionnamelimit = \theme_essentialbe\toolbox::get_setting('returntosectiontextlimitfeature');
            ...
            $title = get_string('returntosection', 'theme_essentialbe', array('section' => $sectionname));
    ...
    */
    ...
    public function custom_menu_courses() {
        ...
        $hasdisplaymycourses = \theme_essentialbe\toolbox::get_setting('displaymycourses');
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            $mycoursesorder = \theme_essentialbe\toolbox::get_setting('mycoursesorder');
            if (!$mycoursesorder) {
                $mycoursesorder = 1;
            }
            ...
            $mycoursetitle = \theme_essentialbe\toolbox::get_setting('mycoursetitle');
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('my'.$lateststring.'modules', 'theme_essentialbe');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('my'.$lateststring.'units', 'theme_essentialbe');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('my'.$lateststring.'classes', 'theme_essentialbe');
            } else {
                $branchtitle = get_string('my'.$lateststring.'courses', 'theme_essentialbe');
            }
            ...
            $numcourses = 0;
            $hasdisplayhiddenmycourses = \theme_essentialbe\toolbox::get_setting('displayhiddenmycourses');
            ...
            if (($mycoursesorder == 1) || ($mycoursesorder == 2)) {
                ...
                if ($mycoursesorder == 1) {
                    ...
                    $sortorder = 'id';
                    $mycoursesorderidorder = \theme_essentialbe\toolbox::get_setting('mycoursesorderidorder');
            ...
            if ($courses) {
                $mycoursesmax = \theme_essentialbe\toolbox::get_setting('mycoursesmax');
                if (!$mycoursesmax) {
    ...
    public function custom_menu_themecolours() {
        ...
        if (!isguestuser()) {
            ...
            foreach (range(1, 4) as $alternativethemenumber) {
                if (\theme_essentialbe\toolbox::get_setting('enablealternativethemecolors' . $alternativethemenumber)) {
            ...
            if (!empty($alternativethemes)) {
                ...
                foreach ($alternativethemes as $alternativethemenumber) {
                    if (\theme_essentialbe\toolbox::get_setting('alternativethemename' . $alternativethemenumber)) {
                        $alternativethemeslabel = \theme_essentialbe\toolbox::get_setting(
                    ...
                    $branch->add($this->getfontawesomemarkup('square', array('colours-alternative'.$alternativethemenumber)).
                        ...
                        new moodle_url($this->page->url, array('essentialbecolours' => 'alternative' . $alternativethemenumber)),
                            $alternativethemeslabel);
                }
            }
        }
    ...
    public function custom_menu_activitystream() {
        if (!isguestuser()) {
            if ((($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse') ||
                ...
                $branchtitle = get_string('thiscourse', 'theme_essentialbe');
                ...
                $branchtitle = get_string('people', 'theme_essentialbe');
    ...
    public function custom_menu_goto_bottom() {
        ...
        if (($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse') ||
            ...
            $menu->add($gotobottom, new moodle_url('#region-main'), get_string('gotobottom', 'theme_essentialbe'));
    ...
    public function custom_menu_editing() {
        $html = '';
        if (\theme_essentialbe\toolbox::get_setting('displayeditingmenu')) {
            if ($this->page->user_allowed_editing()) {
                ...
                if ($buttontoadd) {
                    ...
                    if (\theme_essentialbe\toolbox::get_setting('hidedefaulteditingbutton')) {
        ...
        if (!isloggedin()) {
            ...
            if (\core\session\manager::is_loggedinas()) {
                ...
                $branchlabel = '<em>'.$this->getfontawesomemarkup('key').fullname($realuser, true).
                    get_string('loggedinas', 'theme_essentialbe').fullname($USER, true).'</em>';
            } else {
            ...
            if (is_mnet_remote_user($USER) && $idprovider = $DB->get_record('mnet_host', array('id' => $USER->mnethostid))) {
                $branchlabel = '<em>'.$this->getfontawesomemarkup('users').get_string('loggedinfrom', 'theme_essentialbe').
                    $idprovider->name.'</em>';
            ...
            if ($course->id == SITEID) {
                $branchlabel = '<em>'.$this->getfontawesomemarkup('list-alt').get_string('mygrades', 'theme_essentialbe').'</em>';
                ...
                if (has_capability('gradereport/user:view', $context) && $course->showgrades) {
                    ...
                    $branchlabel = '<em>'.$this->getfontawesomemarkup('list-alt').
                        get_string('coursegrades', 'theme_essentialbe').'</em>';
     ...
     * @return string
     */
    protected function theme_essentialbe_render_helplink() {
        global $USER, $CFG;
        if (!\theme_essentialbe\toolbox::get_setting('helplinktype')) {
            return false;
        }
        ...
        if (\theme_essentialbe\toolbox::get_setting('helplinktype') === '1') {
            if (\theme_essentialbe\toolbox::get_setting('helplink') &&
                    filter_var(\theme_essentialbe\toolbox::get_setting('helplink'), FILTER_VALIDATE_EMAIL)) {
                $branchurl = 'mailto:' . \theme_essentialbe\toolbox::get_setting('helplink').'?cc='.$USER->email;
        ...
        if (\theme_essentialbe\toolbox::get_setting('helplinktype') === '2') {
            if (\theme_essentialbe\toolbox::get_setting('helplink') &&
                    filter_var(\theme_essentialbe\toolbox::get_setting('helplink'),
                        FILTER_VALIDATE_URL, FILTER_FLAG_SCHEME_REQUIRED)) {
                $branchurl = \theme_essentialbe\toolbox::get_setting('helplink');
                $target = '_blank';
            } else if ((!\theme_essentialbe\toolbox::get_setting('helplink')) &&
     ...
     */
    protected function theme_essentialbe_render_preferences($context) {
        global $USER, $CFG;
        ...
        if ($CFG->enablebadges && has_capability('moodle/badges:manageownbadges', $context)) {
            $branchlabel = '<em>'.$this->getfontawesomemarkup('certificate').
                get_string('badgepreferences', 'theme_essentialbe').'</em>';
    ...
    */
    ...
    public function render_social_network($socialnetwork) {
        if (\theme_essentialbe\toolbox::get_setting($socialnetwork)) {
            $icon = $socialnetwork;
            ...
            $socialnetworklabel = get_string($socialnetwork, 'theme_essentialbe');
            $socialhtml .= html_writer::start_tag('button', array('type' => "button",
                'class' => 'socialicon ' . $socialnetwork,
                'onclick' => "window.open('".\theme_essentialbe\toolbox::get_setting($socialnetwork)."')",
     ...
     * @return string HTML.
     */
    public function essentialbe_blocks($region, $classes = array(), $tag = 'aside', $blocksperrowsetting = false) {
        if ($this->page->blocks->is_known_region($region)) {
            ...
            if ($blocksperrowsetting !== false) {
                if (is_int($blocksperrowsetting)) {
                    ...
                    $blocksperrow = \theme_essentialbe\toolbox::get_setting($blocksperrowsetting);
                }
            } else {
                $blocksperrow = false;
            }
            ...
            if ($editing) {
                $regioncontent .= html_writer::tag('span', html_writer::tag('span', get_string('region-'.$region, 'theme_essentialbe')),
            ...
            if ($this->page->blocks->region_has_content($region, $this)) {
                if ($blocksperrow !== false) {
                    ...
                    $regioncontent .= $this->essentialbe_blocks_for_region($region, $blocksperrow, $editing);
    ...
    public function standard_footer_html() {
        ...
        $output .= html_writer::start_tag('div', array ('class' => 'themecredit')).
            get_string('credit', 'theme_essentialbe',
            array('name' => html_writer::link('https://moodle.org/plugins/theme_essentialbe', 'Essential', array('target' => '_blank')))).
    ...
    public function essentialbe_marketing_button($spot) {
        $o = '';
        $url = \theme_essentialbe\toolbox::get_setting('marketing'.$spot.'buttonurl');
        if (!empty($url)) {
            $url = '<a href="'.$url.'" ';
            $url .= 'target="'.\theme_essentialbe\toolbox::get_setting('marketing'.$spot.'target').'" class="marketing-button">';
            $url .= \theme_essentialbe\toolbox::get_setting('marketing'.$spot.'buttontext', true);
            $url .= '</a>';
        }
        $edit = $this->essentialbe_edit_button('frontpage');
     ...
     *
     * Ensure that the 'essentialbe_edit_button_settingspage' method has the 'keys' and values for the sections
     ...
     */
    public function essentialbe_edit_button($sectionkey, $buttontext = null) {
        global $CFG;
        if ($this->page->user_is_editing() && is_siteadmin()) {
            $themesectionkey = $this->essentialbe_edit_button_settingspage($sectionkey);
     ...
     * call the 'essentialbe_edit_button' method for.
     *
     * @param string $sectionkey settings section key.
     * @return string or false if not found.
     */
    protected function essentialbe_edit_button_settingspage($sectionkey) {
        $themesectionkey = false;

        switch ($sectionkey) {
            case 'frontpage':
                $themesectionkey = 'theme_essentialbe_frontpage';
            break;
            case 'footer':
                $themesectionkey = 'theme_essentialbe_footer';
            break;
            case 'slideshow':
                $themesectionkey = 'theme_essentialbe_slideshow';
            break;
        }
    ...
    public function get_title($location) {
        ...
        if ($location === 'navbar') {
            ...
            switch (\theme_essentialbe\toolbox::get_setting('navbartitle')) {
                case 0:
                    return false;
                break;
                case 1:
            ...
            switch (\theme_essentialbe\toolbox::get_setting('headertitle')) {
                case 0:
                    return false;
                    break;
                case 1:
    ...
    public function version_alert() {
        ...
        if (($CFG->version < 2016052300.00) || ($CFG->version >= 2016111400.00)) {
            ...
            $result .= '<span class="title">'.get_string('versionalerttitle', 'theme_essentialbe').'</span><br />'.
                get_string('versionalerttext1', 'theme_essentialbe').'<br />'.
                get_string('versionalerttext2', 'theme_essentialbe');
            $result .= '</div>';
        }
    ...
    public function favicon() {
        $favicon = \theme_essentialbe\toolbox::get_setting('favicon', 'format_file_url');
