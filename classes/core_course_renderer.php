...
class theme_essentialbe_core_course_renderer extends core_course_renderer {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        $this->enablecategoryicon = \theme_essentialbe\toolbox::get_setting('enablecategoryicon');
    }
    ...
    protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
        ...
        if ($coursecat->get_children_count()) {
            ...
            $coursecounttitle = get_string('numberofcoursesandsubcatcourses', 'theme_essentialbe');
        } else {
        ...
        if (\theme_essentialbe\toolbox::get_setting('enablecategoryicon')) {
            $customcategoryicon = \theme_essentialbe\toolbox::get_setting('categoryicon'.$coursecat->id);
            if ($customcategoryicon &&
                \theme_essentialbe\toolbox::get_setting('enablecustomcategoryicon')) {
                // User has set a value for the category.
                $val = $customcategoryicon;
            } else {
                // User hasn't set a value for the category, get the default.
                $val = \theme_essentialbe\toolbox::get_setting('defaultcategoryicon');
            }
        }
        if (!empty($val)) {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        if ($coursehascontacts) {
            ...
            foreach ($course->get_course_contacts() as $userid => $coursecontact) {
                $faiconsetting = \theme_essentialbe\toolbox::get_setting('courselistteachericon');
    ...
    /**
     * Serves requests to /theme/essentialbe/inspector.ajax.php
     *
