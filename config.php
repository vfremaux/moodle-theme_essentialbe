...
if ((get_config('theme_essentialbe', 'enablealternativethemecolors1')) ||
        ...
        (get_config('theme_essentialbe', 'enablealternativethemecolors4'))
) {
    $THEME->sheets[] = 'essentialbe-alternative';
}

if (get_config('theme_essentialbe', 'customscrollbars')) {
    $THEME->sheets[] = 'essentialbe-scrollbars';
}
...
$THEME->javascripts_footer = array('essentialbe');
...
if (get_config('theme_essentialbe', 'fppagetopblocks') > 0) {
    $fpaddregions[] = 'page-top';
}
if (get_config('theme_essentialbe', 'haveheaderblock') > 0) {
    $baseregions[] = 'header';
    $fpaddregions[] = 'header';
}
